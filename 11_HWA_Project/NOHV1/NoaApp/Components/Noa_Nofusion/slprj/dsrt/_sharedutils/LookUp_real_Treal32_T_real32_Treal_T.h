...
#ifndef RTW_HEADER_LookUp_real_Treal32_T_real32_Treal_T_h_
#define RTW_HEADER_LookUp_real_Treal32_T_real32_Treal_T_h_
#include "rtwtypes.h"

void LookUp_real_Treal32_T_real32_Treal_T(real_T *pY, const real32_T *pYData,
  real32_T u, const real_T *pUData, uint32_T iHi);

#endif                  /* RTW_HEADER_LookUp_real_Treal32_T_real32_Treal_T_h_ */
