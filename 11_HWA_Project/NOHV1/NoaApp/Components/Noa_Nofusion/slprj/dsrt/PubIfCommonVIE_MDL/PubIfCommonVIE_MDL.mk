...
BUILD_ERROR                    = [sprintf('DSRT MAKE ERROR: Make process failed for model PubIfCommonVIE_MDL.')]
SYS_TARGET_FILE                = any
PROJ_MARKER_FILE               = no
...
DS_PROTECTION                     = OFF
MW_MAKEFILE                       = PubIfCommonVIE_MDL.mk
...
# MW_COMPUTER                     = PCWIN64
MW_MODEL                          = PubIfCommonVIE_MDL
MW_MODEL_MODULES                  = PubIfCommonVIE_MDL.c PubIfCommonVIE_MDL_data.c
# MW_MODEL_MODULES_OBJ            = PubIfCommonVIE_MDL.obj PubIfCommonVIE_MDL_data.obj 
MW_S_FUNCTIONS                    = 
# MW_S_FUNCTIONS_OBJ              = 
MW_S_FUNCTIONS_LIB                = 
# MW_SOLVER                       = 
...
MW_MODELLIB                       = PubIfCommonVIE_MDL_rtwlib.lib
MW_MODELREF_LINK_LIBS             = 
MW_MODELREF_TARGET_TYPE           = RTW
MW_MODELREFS                      = 
MW_MODELREF_LINK_RSPFILE          = PubIfCommonVIE_MDL_ref.rsp
...
%set DSRT_COMMON_HDR_DIRPATHS += \
    "$(START_DIR)" \
    "$(START_DIR)\slprj\dsrt\PubIfCommonVIE_MDL" \
...
%set LIB_BASENAME = PubIfCommonVIE_MDL
...
INTERFACE_LIB_$(LIB_BASENAME)_CC_SRC_FILES := PubIfCommonVIE_MDL.$(MW_TARGET_LANG_EXT) 
