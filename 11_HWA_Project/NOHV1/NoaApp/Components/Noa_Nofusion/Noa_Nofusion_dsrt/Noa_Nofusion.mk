...
BUILD_ERROR                    = [sprintf('DSRT MAKE ERROR: Make process failed for model Noa_Nofusion.')]
SYS_TARGET_FILE                = any
PROJ_MARKER_FILE               = no
...
# MW_COMPUTER                     = PCWIN64
MW_MODEL                          = Noa_Nofusion
MW_MODEL_MODULES                  = Noa_Nofusion_data.c Noa_Nofusion_dsmpb_bd.c Noa_Nofusion_dsmpbap.c Noa_Nofusion_dsrtmdlfcn.c Noa_Nofusion_dsrtmf.c Noa_Nofusion_dsrttf.c roadfus_L3.c mcuEQ4.c
# MW_MODEL_MODULES_OBJ            = Noa_Nofusion_data.obj Noa_Nofusion_dsmpb_bd.obj Noa_Nofusion_dsmpbap.obj Noa_Nofusion_dsrtmdlfcn.obj Noa_Nofusion_dsrtmf.obj Noa_Nofusion_dsrttf.obj roadfus_L3.obj mcuEQ4.obj 
MW_S_FUNCTIONS                    = 
# MW_S_FUNCTIONS_OBJ              = 
MW_S_FUNCTIONS_LIB                = $(START_DIR)\slprj\dsrt\_sharedutils\rtwshared.lib
# MW_SOLVER                       = 
# MW_SOLVER_OBJ                   = 
MW_NUMST                          = 3
MW_TID01EQ                        = 0
...
MW_SHARED_LIB                     = ..\slprj\dsrt\_sharedutils\rtwshared.lib
MW_SHARED_LIB_SRCS_WILD           = ..\slprj\dsrt\_sharedutils\*.c*
MW_SHARED_LIB_SRCS_DIR            = ..\slprj\dsrt\_sharedutils
MW_SHARED_LIB_OBJS_DIR            = ..\slprj\dsrt\_sharedutils

MW_RELATIVE_PATH_TO_ANCHOR        = ..

MW_MODELLIB                       = 
MW_MODELREF_LINK_LIBS             = ..\slprj\dsrt\PubIfChassisHMI_MDL\PubIfChassisHMI_MDL_rtwlib.lib ..\slprj\dsrt\PubIfCommonVIE_MDL\PubIfCommonVIE_MDL_rtwlib.lib ..\slprj\dsrt\PubIfControlLATC_MDL\PubIfControlLATC_MDL_rtwlib.lib ..\slprj\dsrt\PubIfControlLONC_MDL\PubIfControlLONC_MDL_rtwlib.lib ..\slprj\dsrt\PubIfDecisionLSM_MDL\PubIfDecisionLSM_MDL_rtwlib.lib ..\slprj\dsrt\PubIfDecisionPLAN_MDL\PubIfDecisionPLAN_MDL_rtwlib.lib ..\slprj\dsrt\PubIfStateVSM_MDL\PubIfStateVSM_MDL_rtwlib.lib
MW_MODELREF_TARGET_TYPE           = NONE
MW_MODELREFS                      = PubIfChassisHMI_MDL PubIfCommonVIE_MDL PubIfControlLATC_MDL PubIfDecisionLSM_MDL PubIfControlLONC_MDL PubIfDecisionPLAN_MDL PubIfStateVSM_MDL 
MW_MODELREF_LINK_RSPFILE          = Noa_Nofusion_ref.rsp
...
%set DSRT_COMMON_HDR_DIRPATHS += \
    "$(START_DIR)\Noa_Nofusion_dsrt\referenced_model_includes" \
    "$(START_DIR)" \
    "$(START_DIR)\Noa_Nofusion_dsrt" \
...
INTERFACE_LIB_$(LIB_BASENAME)_CC_SRC_FILES := Noa_Nofusion.$(MW_TARGET_LANG_EXT) 
