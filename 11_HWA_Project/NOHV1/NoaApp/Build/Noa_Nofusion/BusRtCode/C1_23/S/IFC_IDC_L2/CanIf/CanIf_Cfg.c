...
static CanIfTxPduConfig TxPduConfig[] = {
    /* V71_V4.1.1_NOA */
    {
        CanIf_V71_V4_1_1_NOA_IFC_FD1_FrameTrig, /* CanIf Pdu Id */
        299, /* 0x0000012B CAN Id */
...
{
     {
            ...
            6,     /* Index in StateManager to handle ComControllerEnable state */
...
void CanIf_VariableInitialize(void)
{
    ...
    StateManager_SetState_Mutex(6,controllerState);
