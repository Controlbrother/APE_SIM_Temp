...
/* definition of handle set for IFC_FD1 */
DsBusCustomCodePduFeatureHandle Feature_UserCode_TX_Feature_IFC_FD1_119634_232434_FH; /**< Feature Handle */
DsBusCustomCodePduHandle Feature_UserCode_TX_Feature_IFC_FD1_119634_232434_PH; /**< PDU Handle */
DsBusCustomCodeSignalHandle Feature_UserCode_TX_Feature_IFC_FD1_119634_232434_S[2];
...
Std_ReturnType UserCode_PreparePduSend(Feature_PduIdType PduId, const PduInfoType * PduInfoPtr)
{
    ...
    switch (PduId)
    {
        case Feature_IFC_FD1_209458_119634_232434_TX:
        {
            DsBusCustomCodePdu_setSduLength(Feature_UserCode_TX_Feature_IFC_FD1_119634_232434_PH, PduInfoPtr->SduLength);
            DsBusCustomCodePdu_setSduDataPtr(Feature_UserCode_TX_Feature_IFC_FD1_119634_232434_PH, PduInfoPtr->SduDataPtr);
            result = DsBusCustomCode_onPduFeatureExecution_checksum_acc1( Feature_UserCode_TX_Feature_IFC_FD1_119634_232434_FH);
            break;
        }
    }
    return result;
...
{
    {
        /* Init Pdu UserCode-Feature IFC_FD1 */
        DsBusCustomCodeUserCodePduFeature_generateHandle(&Feature_UserCode_TX_Feature_IFC_FD1_119634_232434_FH);
        DsBusCustomCode_setName(Feature_UserCode_TX_Feature_IFC_FD1_119634_232434_FH, "checksum_acc1");
        DsBusCustomCodePdu_generateHandle(&Feature_UserCode_TX_Feature_IFC_FD1_119634_232434_PH);
        DsBusCustomCodePduFeature_setPdu(Feature_UserCode_TX_Feature_IFC_FD1_119634_232434_FH, Feature_UserCode_TX_Feature_IFC_FD1_119634_232434_PH);
        DsBusCustomCodeSignal_generateHandle(&Feature_UserCode_TX_Feature_IFC_FD1_119634_232434_S[0]);
        DsBusCustomCodeSignal_generateHandle(&Feature_UserCode_TX_Feature_IFC_FD1_119634_232434_S[1]);
        DsBusCustomCodeUserCodePduFeature_setNumberOfUserSignals(Feature_UserCode_TX_Feature_IFC_FD1_119634_232434_FH, 2);
        DsBusCustomCodeUserCodePduFeature_setUserSignals(Feature_UserCode_TX_Feature_IFC_FD1_119634_232434_FH, Feature_UserCode_TX_Feature_IFC_FD1_119634_232434_S);
        /* initialization of handle set for IFC_FD1 */
        DsBusCustomCode_setName(Feature_UserCode_TX_Feature_IFC_FD1_119634_232434_PH, "IFC_FD1" );
        DsBusCustomCodePdu_setIsTx(Feature_UserCode_TX_Feature_IFC_FD1_119634_232434_PH, TRUE);
        /* set signal Checksum_IFC1 properties */
        DsBusCustomCode_setName(Feature_UserCode_TX_Feature_IFC_FD1_119634_232434_S[0], "Checksum_IFC1");
        DsBusCustomCodeSignal_setStartBitPosition(Feature_UserCode_TX_Feature_IFC_FD1_119634_232434_S[0], 64);
        DsBusCustomCodeSignal_setLength(Feature_UserCode_TX_Feature_IFC_FD1_119634_232434_S[0], 8);
        DsBusCustomCodeSignal_setEndianness(Feature_UserCode_TX_Feature_IFC_FD1_119634_232434_S[0], BigEndian);
        /* set signal Checksum_IFC2 properties */
        DsBusCustomCode_setName(Feature_UserCode_TX_Feature_IFC_FD1_119634_232434_S[1], "Checksum_IFC2");
        DsBusCustomCodeSignal_setStartBitPosition(Feature_UserCode_TX_Feature_IFC_FD1_119634_232434_S[1], 128);
        DsBusCustomCodeSignal_setLength(Feature_UserCode_TX_Feature_IFC_FD1_119634_232434_S[1], 8);
        DsBusCustomCodeSignal_setEndianness(Feature_UserCode_TX_Feature_IFC_FD1_119634_232434_S[1], BigEndian);
        /* call user code init function */
        DsBusCustomCode_onApplicationInit_checksum_acc1( Feature_UserCode_TX_Feature_IFC_FD1_119634_232434_FH);
    }
