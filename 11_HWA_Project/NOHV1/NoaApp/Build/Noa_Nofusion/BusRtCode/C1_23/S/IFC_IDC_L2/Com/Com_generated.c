...
static uint8 Com_Frame_TX_Com_IFC_FD1_209458_119634_232434 [64];
static PduInfoType Com_Pdu_TX_Com_IFC_FD1_209458_119634_232434;
uint8 Com_TX_Inst_299_IFCFuncAngCmdReqFlag_206868_119634_232434_sgn_val;
uint8 Com_TX_Inst_299_Checksum_IFC1_206869_119634_232434_sgn_val;
uint16 Com_TX_Inst_299_IFCTrqOvlCmdProtnValue_206870_119634_232434_sgn_val;
uint16 Com_TX_Inst_299_IFCTrqOvlCmdReqValue_206871_119634_232434_sgn_val;
uint8 Com_TX_Inst_299_IFCFuncTrqCmdReqFlag_206872_119634_232434_sgn_val;
uint8 Com_TX_Inst_299_IFCVibrationWarning_206873_119634_232434_sgn_val;
uint8 Com_TX_Inst_299_RollingCounter_IFC1_206874_119634_232434_sgn_val;
uint8 Com_TX_Inst_299_Checksum_IFC2_206875_119634_232434_sgn_val;
uint16 Com_TX_Inst_299_IFCAngCmdReqValue_206876_119634_232434_sgn_val;
uint16 Com_TX_Inst_299_IFCAngCmdReqProtnValue_206877_119634_232434_sgn_val;
uint8 Com_TX_Inst_299_RollingCounter_IFC2_206878_119634_232434_sgn_val;
...
static BinaryHeap timingQueue_6 = BINARY_HEAP_CREATE(Com_CyclicHeapEntry, CyclicCompare);
...
static void ComControllerStateChanged6(uint32 index, uint8 newState, uint8 oldState)
{
    ...
    if (newState > 0)
    {
        ...
        BinaryHeapClear(&timingQueue_6);
        Com_Schedule_CyclicTimingPdus(&timingQueue_6,Com_IFC_FD1_209458_119634_232434, 0LL, 20000L);
    }
}
...
void Com_Init(const Com_ConfigType* config)
{
    ...
    Com_Pdu_TX_Com_IFC_FD1_209458_119634_232434.SduDataPtr = Com_Frame_TX_Com_IFC_FD1_209458_119634_232434;
    Com_Pdu_TX_Com_IFC_FD1_209458_119634_232434.SduLength  = 64;
    Com_Pdu_TX_Com_IFC_FD1_209458_119634_232434.MetaDataPtr = NULL_PTR;
...
void Com_VariableInitialize(void)
{
    ...
    memset(Com_Frame_TX_Com_IFC_FD1_209458_119634_232434, 0x00, sizeof(Com_Frame_TX_Com_IFC_FD1_209458_119634_232434));
    /* Initialization of the TX signals and triggers */
    Com_TX_Inst_299_IFCFuncAngCmdReqFlag_206868_119634_232434_sgn_val = (uint8) 0;
    Rte_SetCodedValue(Com_X_Inst_299_IFCFuncAngCmdReqFlag_206868_119634_232434, 1);
    /* Signal: IFCFuncAngCmdReqFlag */
            {
                int copyCounter;
                uint8* destData = (uint8*)Com_Pdu_TX_Com_IFC_FD1_209458_119634_232434.SduDataPtr;
                uint8 shiftData = ((uint8)READ8(&Com_TX_Inst_299_IFCFuncAngCmdReqFlag_206868_119634_232434_sgn_val) & (uint8)0x7) << 5;
                uint8 mask = (uint8)0x7 << 5;
                uint8 resultMask = INT8_TO_BE(~mask);
                uint8 resultData = INT8_TO_BE(shiftData);
                resultData = (READ8(&destData[21]) & resultMask) | resultData;
                for(copyCounter = 0; copyCounter < 1; copyCounter++)
                    destData[21 + copyCounter] = ((uint8*)&resultData)[copyCounter];
            }

    Com_TX_Inst_299_Checksum_IFC1_206869_119634_232434_sgn_val = (uint8) 0;
    Rte_SetCodedValue(Com_X_Inst_299_Checksum_IFC1_206869_119634_232434, 1);
    /* Signal: Checksum_IFC1 */
            {
                int copyCounter;
                uint8* destData = (uint8*)Com_Pdu_TX_Com_IFC_FD1_209458_119634_232434.SduDataPtr;
                uint8 shiftData = ((uint8)READ8(&Com_TX_Inst_299_Checksum_IFC1_206869_119634_232434_sgn_val) & (uint8)0xFF) << 0;
    ...
    Com_TX_Inst_299_IFCTrqOvlCmdProtnValue_206870_119634_232434_sgn_val = (uint16) 7169;
    Rte_SetCodedValue(Com_X_Inst_299_IFCTrqOvlCmdProtnValue_206870_119634_232434, 1);
    /* Signal: IFCTrqOvlCmdProtnValue */
            {
                int copyCounter;
                uint8* destData = (uint8*)Com_Pdu_TX_Com_IFC_FD1_209458_119634_232434.SduDataPtr;
                uint16 shiftData = ((uint16)READ16(&Com_TX_Inst_299_IFCTrqOvlCmdProtnValue_206870_119634_232434_sgn_val) & (uint16)0x3FFF) << 2;
                uint16 mask = (uint16)0x3FFF << 2;
                uint16 resultMask = INT16_TO_BE(~mask);
                uint16 resultData = INT16_TO_BE(shiftData);
                resultData = (READ16(&destData[9]) & resultMask) | resultData;
                for(copyCounter = 0; copyCounter < 2; copyCounter++)
                    destData[9 + copyCounter] = ((uint8*)&resultData)[copyCounter];
            }

    Com_TX_Inst_299_IFCTrqOvlCmdReqValue_206871_119634_232434_sgn_val = (uint16) 1023;
    Rte_SetCodedValue(Com_X_Inst_299_IFCTrqOvlCmdReqValue_206871_119634_232434, 1);
    /* Signal: IFCTrqOvlCmdReqValue */
            {
                int copyCounter;
                uint8* destData = (uint8*)Com_Pdu_TX_Com_IFC_FD1_209458_119634_232434.SduDataPtr;
                uint16 shiftData = ((uint16)READ16(&Com_TX_Inst_299_IFCTrqOvlCmdReqValue_206871_119634_232434_sgn_val) & (uint16)0x7FF) << 5;
                uint16 mask = (uint16)0x7FF << 5;
                uint16 resultMask = INT16_TO_BE(~mask);
                uint16 resultData = INT16_TO_BE(shiftData);
                resultData = (READ16(&destData[12]) & resultMask) | resultData;
                for(copyCounter = 0; copyCounter < 2; copyCounter++)
                    destData[12 + copyCounter] = ((uint8*)&resultData)[copyCounter];
            }

    Com_TX_Inst_299_IFCFuncTrqCmdReqFlag_206872_119634_232434_sgn_val = (uint8) 0;
    Rte_SetCodedValue(Com_X_Inst_299_IFCFuncTrqCmdReqFlag_206872_119634_232434, 1);
    /* Signal: IFCFuncTrqCmdReqFlag */
            {
                int copyCounter;
                uint8* destData = (uint8*)Com_Pdu_TX_Com_IFC_FD1_209458_119634_232434.SduDataPtr;
                uint8 shiftData = ((uint8)READ8(&Com_TX_Inst_299_IFCFuncTrqCmdReqFlag_206872_119634_232434_sgn_val) & (uint8)0x7) << 5;
                uint8 mask = (uint8)0x7 << 5;
                uint8 resultMask = INT8_TO_BE(~mask);
                uint8 resultData = INT8_TO_BE(shiftData);
    ...
    Com_TX_Inst_299_IFCVibrationWarning_206873_119634_232434_sgn_val = (uint8) 0;
    Rte_SetCodedValue(Com_X_Inst_299_IFCVibrationWarning_206873_119634_232434, 1);
    /* Signal: IFCVibrationWarning */
            {
                int copyCounter;
                uint8* destData = (uint8*)Com_Pdu_TX_Com_IFC_FD1_209458_119634_232434.SduDataPtr;
                uint8 shiftData = ((uint8)READ8(&Com_TX_Inst_299_IFCVibrationWarning_206873_119634_232434_sgn_val) & (uint8)0x3) << 0;
    ...
    Com_TX_Inst_299_RollingCounter_IFC1_206874_119634_232434_sgn_val = (uint8) 0;
    Rte_SetCodedValue(Com_X_Inst_299_RollingCounter_IFC1_206874_119634_232434, 1);
    /* Signal: RollingCounter_IFC1 */
            {
                int copyCounter;
                uint8* destData = (uint8*)Com_Pdu_TX_Com_IFC_FD1_209458_119634_232434.SduDataPtr;
                uint8 shiftData = ((uint8)READ8(&Com_TX_Inst_299_RollingCounter_IFC1_206874_119634_232434_sgn_val) & (uint8)0xF) << 0;
    ...
    Com_TX_Inst_299_Checksum_IFC2_206875_119634_232434_sgn_val = (uint8) 0;
    Rte_SetCodedValue(Com_X_Inst_299_Checksum_IFC2_206875_119634_232434, 1);
    /* Signal: Checksum_IFC2 */
            {
                int copyCounter;
                uint8* destData = (uint8*)Com_Pdu_TX_Com_IFC_FD1_209458_119634_232434.SduDataPtr;
                uint8 shiftData = ((uint8)READ8(&Com_TX_Inst_299_Checksum_IFC2_206875_119634_232434_sgn_val) & (uint8)0xFF) << 0;
                uint8 mask = (uint8)0xFF << 0;
                uint8 resultMask = INT8_TO_BE(~mask);
                uint8 resultData = INT8_TO_BE(shiftData);
    ...
    Com_TX_Inst_299_IFCAngCmdReqValue_206876_119634_232434_sgn_val = (uint16) 7800;
    Rte_SetCodedValue(Com_X_Inst_299_IFCAngCmdReqValue_206876_119634_232434, 1);
    /* Signal: IFCAngCmdReqValue */
            {
                int copyCounter;
                uint8* destData = (uint8*)Com_Pdu_TX_Com_IFC_FD1_209458_119634_232434.SduDataPtr;
                uint16 shiftData = ((uint16)READ16(&Com_TX_Inst_299_IFCAngCmdReqValue_206876_119634_232434_sgn_val) & (uint16)0x3FFF) << 2;
                uint16 mask = (uint16)0x3FFF << 2;
                uint16 resultMask = INT16_TO_BE(~mask);
                uint16 resultData = INT16_TO_BE(shiftData);
                resultData = (READ16(&destData[17]) & resultMask) | resultData;
                for(copyCounter = 0; copyCounter < 2; copyCounter++)
                    destData[17 + copyCounter] = ((uint8*)&resultData)[copyCounter];
            }

    Com_TX_Inst_299_IFCAngCmdReqProtnValue_206877_119634_232434_sgn_val = (uint16) 7169;
    Rte_SetCodedValue(Com_X_Inst_299_IFCAngCmdReqProtnValue_206877_119634_232434, 1);
    /* Signal: IFCAngCmdReqProtnValue */
            {
                int copyCounter;
                uint8* destData = (uint8*)Com_Pdu_TX_Com_IFC_FD1_209458_119634_232434.SduDataPtr;
                uint16 shiftData = ((uint16)READ16(&Com_TX_Inst_299_IFCAngCmdReqProtnValue_206877_119634_232434_sgn_val) & (uint16)0x3FFF) << 2;
                uint16 mask = (uint16)0x3FFF << 2;
                uint16 resultMask = INT16_TO_BE(~mask);
                uint16 resultData = INT16_TO_BE(shiftData);
    ...
    Com_TX_Inst_299_RollingCounter_IFC2_206878_119634_232434_sgn_val = (uint8) 0;
    Rte_SetCodedValue(Com_X_Inst_299_RollingCounter_IFC2_206878_119634_232434, 1);
    /* Signal: RollingCounter_IFC2 */
            {
                int copyCounter;
                uint8* destData = (uint8*)Com_Pdu_TX_Com_IFC_FD1_209458_119634_232434.SduDataPtr;
                uint8 shiftData = ((uint8)READ8(&Com_TX_Inst_299_RollingCounter_IFC2_206878_119634_232434_sgn_val) & (uint8)0xF) << 0;
                uint8 mask = (uint8)0xF << 0;
                uint8 resultMask = INT8_TO_BE(~mask);
                uint8 resultData = INT8_TO_BE(shiftData);
...
void Com_OnStart(void)
{
    ...
    ComControllerStateChanged6(6, 1, 0);
...
#endif
{
    ...
    switch (ComTxPduId)
    {
        case Com_IFC_FD1_209458_119634_232434:
        { /* Pdu: IFC_FD1 */
            Feature_ComCounterSignalCount(COUNTERSIGNAL_CALLED_FROM_UPPERLAYER, Feature_IFC_FD1_RollingCounter_IFC1_206874_119634_232434_TX, &Com_TX_Inst_299_RollingCounter_IFC1_206874_119634_232434_sgn_val);
            Feature_ComCounterSignalCount(COUNTERSIGNAL_CALLED_FROM_UPPERLAYER, Feature_IFC_FD1_RollingCounter_IFC2_206878_119634_232434_TX, &Com_TX_Inst_299_RollingCounter_IFC2_206878_119634_232434_sgn_val);
            /* Signal: IFCFuncAngCmdReqFlag */
#if !defined(HOST_DEBUG)
            if (Rte_SetCodedValue(Com_X_Inst_299_IFCFuncAngCmdReqFlag_206868_119634_232434, 0))
#endif
            {
                int copyCounter;
                uint8* destData = (uint8*)Com_Pdu_TX_Com_IFC_FD1_209458_119634_232434.SduDataPtr;
            ...
            /* Signal: Checksum_IFC1 */
#if !defined(HOST_DEBUG)
            if (Rte_SetCodedValue(Com_X_Inst_299_Checksum_IFC1_206869_119634_232434, 0))
#endif
            {
                int copyCounter;
                uint8* destData = (uint8*)Com_Pdu_TX_Com_IFC_FD1_209458_119634_232434.SduDataPtr;
            ...
            /* Signal: IFCTrqOvlCmdProtnValue */
#if !defined(HOST_DEBUG)
            if (Rte_SetCodedValue(Com_X_Inst_299_IFCTrqOvlCmdProtnValue_206870_119634_232434, 0))
#endif
            {
                int copyCounter;
                uint8* destData = (uint8*)Com_Pdu_TX_Com_IFC_FD1_209458_119634_232434.SduDataPtr;
            ...
            /* Signal: IFCTrqOvlCmdReqValue */
#if !defined(HOST_DEBUG)
            if (Rte_SetCodedValue(Com_X_Inst_299_IFCTrqOvlCmdReqValue_206871_119634_232434, 0))
#endif
            {
                int copyCounter;
                uint8* destData = (uint8*)Com_Pdu_TX_Com_IFC_FD1_209458_119634_232434.SduDataPtr;
            ...
            /* Signal: IFCFuncTrqCmdReqFlag */
#if !defined(HOST_DEBUG)
            if (Rte_SetCodedValue(Com_X_Inst_299_IFCFuncTrqCmdReqFlag_206872_119634_232434, 0))
#endif
            {
                int copyCounter;
                uint8* destData = (uint8*)Com_Pdu_TX_Com_IFC_FD1_209458_119634_232434.SduDataPtr;
            ...
            /* Signal: IFCVibrationWarning */
#if !defined(HOST_DEBUG)
            if (Rte_SetCodedValue(Com_X_Inst_299_IFCVibrationWarning_206873_119634_232434, 0))
#endif
            {
                int copyCounter;
                uint8* destData = (uint8*)Com_Pdu_TX_Com_IFC_FD1_209458_119634_232434.SduDataPtr;
            ...
            /* Signal: RollingCounter_IFC1 */
#if !defined(HOST_DEBUG)
            if (Rte_SetCodedValue(Com_X_Inst_299_RollingCounter_IFC1_206874_119634_232434, 0))
#endif
            {
                int copyCounter;
                uint8* destData = (uint8*)Com_Pdu_TX_Com_IFC_FD1_209458_119634_232434.SduDataPtr;
            ...
            /* Signal: Checksum_IFC2 */
#if !defined(HOST_DEBUG)
            if (Rte_SetCodedValue(Com_X_Inst_299_Checksum_IFC2_206875_119634_232434, 0))
#endif
            {
                int copyCounter;
                uint8* destData = (uint8*)Com_Pdu_TX_Com_IFC_FD1_209458_119634_232434.SduDataPtr;
            ...
            /* Signal: IFCAngCmdReqValue */
#if !defined(HOST_DEBUG)
            if (Rte_SetCodedValue(Com_X_Inst_299_IFCAngCmdReqValue_206876_119634_232434, 0))
#endif
            {
                int copyCounter;
                uint8* destData = (uint8*)Com_Pdu_TX_Com_IFC_FD1_209458_119634_232434.SduDataPtr;
            ...
            /* Signal: IFCAngCmdReqProtnValue */
#if !defined(HOST_DEBUG)
            if (Rte_SetCodedValue(Com_X_Inst_299_IFCAngCmdReqProtnValue_206877_119634_232434, 0))
#endif
            {
                int copyCounter;
                uint8* destData = (uint8*)Com_Pdu_TX_Com_IFC_FD1_209458_119634_232434.SduDataPtr;
            ...
            /* Signal: RollingCounter_IFC2 */
#if !defined(HOST_DEBUG)
            if (Rte_SetCodedValue(Com_X_Inst_299_RollingCounter_IFC2_206878_119634_232434, 0))
#endif
            {
                int copyCounter;
                uint8* destData = (uint8*)Com_Pdu_TX_Com_IFC_FD1_209458_119634_232434.SduDataPtr;
            ...
            if (Feature_ComPreparePduSend(Feature_IFC_FD1_209458_119634_232434_TX, &Com_Pdu_TX_Com_IFC_FD1_209458_119634_232434) != E_OK)
            {
                result = E_DISABLED;
            }
            ...
            {
                result = PduR_ComTransmit(PDUR_TX_IFC_FD1_119634_232434, &Com_Pdu_TX_Com_IFC_FD1_209458_119634_232434);
            }
            if (result != E_OK)
            {
                /* Signal: RollingCounter_IFC1 */
                Feature_ComCounterSignalRevert(Feature_IFC_FD1_RollingCounter_IFC1_206874_119634_232434_TX);
                /* Signal: RollingCounter_IFC2 */
                Feature_ComCounterSignalRevert(Feature_IFC_FD1_RollingCounter_IFC2_206878_119634_232434_TX);
            }
            return result;
        }
    }
...
Std_ReturnType Com_TriggerTransmit(PduIdType ComTxPduId, PduInfoType * PduInfoPtr)
{
    ...
    switch (ComTxPduId)
    {
        case Com_IFC_FD1_209458_119634_232434:
        { /* Pdu: IFC_FD1 */
            Feature_ComCounterSignalCount(COUNTERSIGNAL_CALLED_FROM_LOWERLAYER, Feature_IFC_FD1_RollingCounter_IFC1_206874_119634_232434_TX, &Com_TX_Inst_299_RollingCounter_IFC1_206874_119634_232434_sgn_val);
            Feature_ComCounterSignalCount(COUNTERSIGNAL_CALLED_FROM_LOWERLAYER, Feature_IFC_FD1_RollingCounter_IFC2_206878_119634_232434_TX, &Com_TX_Inst_299_RollingCounter_IFC2_206878_119634_232434_sgn_val);
            /* Signal: IFCFuncAngCmdReqFlag */
#if !defined(HOST_DEBUG)
            if (Rte_SetCodedValue(Com_X_Inst_299_IFCFuncAngCmdReqFlag_206868_119634_232434, 0))
#endif
            ...
            /* call to PDU feature before transmission */
            Feature_ComPreparePduSend(Feature_IFC_FD1_209458_119634_232434_TX, &Com_Pdu_TX_Com_IFC_FD1_209458_119634_232434);
            if (PduInfoPtr != NULL_PTR)
            {
                PduInfoPtr->SduLength = Com_Pdu_TX_Com_IFC_FD1_209458_119634_232434.SduLength;
                if(PduInfoPtr->SduDataPtr != Com_Pdu_TX_Com_IFC_FD1_209458_119634_232434.SduDataPtr)
                {
                    memcpy(PduInfoPtr->SduDataPtr, Com_Pdu_TX_Com_IFC_FD1_209458_119634_232434.SduDataPtr, PduInfoPtr->SduLength);
                }
            }
...
uint8 Com_SendSignal(Com_SignalIdType SignalId, const void * SignalDataPtr)
{
    ...
    switch (SignalId)
    {
        case Com_X_Inst_299_IFCFuncAngCmdReqFlag_206868_119634_232434:
        {
            Com_TX_Inst_299_IFCFuncAngCmdReqFlag_206868_119634_232434_sgn_val = *((uint8*) SignalDataPtr);
            return E_OK;
        }
        case Com_X_Inst_299_Checksum_IFC1_206869_119634_232434:
        {
            Com_TX_Inst_299_Checksum_IFC1_206869_119634_232434_sgn_val = *((uint8*) SignalDataPtr);
            return E_OK;
        }
        case Com_X_Inst_299_IFCTrqOvlCmdProtnValue_206870_119634_232434:
        {
            Com_TX_Inst_299_IFCTrqOvlCmdProtnValue_206870_119634_232434_sgn_val = *((uint16*) SignalDataPtr);
            return E_OK;
        }
        case Com_X_Inst_299_IFCTrqOvlCmdReqValue_206871_119634_232434:
        {
            Com_TX_Inst_299_IFCTrqOvlCmdReqValue_206871_119634_232434_sgn_val = *((uint16*) SignalDataPtr);
            return E_OK;
        }
        case Com_X_Inst_299_IFCFuncTrqCmdReqFlag_206872_119634_232434:
        {
            Com_TX_Inst_299_IFCFuncTrqCmdReqFlag_206872_119634_232434_sgn_val = *((uint8*) SignalDataPtr);
            return E_OK;
        }
        case Com_X_Inst_299_IFCVibrationWarning_206873_119634_232434:
        {
            Com_TX_Inst_299_IFCVibrationWarning_206873_119634_232434_sgn_val = *((uint8*) SignalDataPtr);
            return E_OK;
        }
        case Com_X_Inst_299_RollingCounter_IFC1_206874_119634_232434:
        {
            /* do not manage any data from UpperLayer (e.g. Model), due to CounterSignalFeature is active */
            return E_OK;
        }
        case Com_X_Inst_299_Checksum_IFC2_206875_119634_232434:
        {
            Com_TX_Inst_299_Checksum_IFC2_206875_119634_232434_sgn_val = *((uint8*) SignalDataPtr);
            return E_OK;
        }
        case Com_X_Inst_299_IFCAngCmdReqValue_206876_119634_232434:
        {
            Com_TX_Inst_299_IFCAngCmdReqValue_206876_119634_232434_sgn_val = *((uint16*) SignalDataPtr);
            return E_OK;
        }
        case Com_X_Inst_299_IFCAngCmdReqProtnValue_206877_119634_232434:
        {
            Com_TX_Inst_299_IFCAngCmdReqProtnValue_206877_119634_232434_sgn_val = *((uint16*) SignalDataPtr);
            return E_OK;
        }
        case Com_X_Inst_299_RollingCounter_IFC2_206878_119634_232434:
        {
            /* do not manage any data from UpperLayer (e.g. Model), due to CounterSignalFeature is active */
            return E_OK;
        }
...
#endif
{
    ...
    */
    Com_CheckHeapAndSend(&timingQueue_6, period, 0);
}
...
{
    if (BM_ADAS_CAN_23_IFC_IDC_L2__CreditCountersAvailable() > 0) 
    {
        /* Trigger Tx Function */
