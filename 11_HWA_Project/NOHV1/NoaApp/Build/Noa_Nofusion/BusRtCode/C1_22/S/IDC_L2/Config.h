...
*
*  @brief Config File for F:/05_dspace_Work_Files/11_HWA_Project/NOHV1/NoaApp/Build/Noa_Nofusion/BusRtCode/C1_22/S/IDC_L2/Ecu.mk
*
*  @author
*
*  @description
...
/* Feature */
#define RawData_Init ASPECT_UNIQUE(RawData_Init)

#define RawData_VariableInitialize ASPECT_UNIQUE(RawData_VariableInitialize)

#define RawData_OnStart ASPECT_UNIQUE(RawData_OnStart)

#define RawData_MainFunction ASPECT_UNIQUE(RawData_MainFunction)

#define RawData_SetValue ASPECT_UNIQUE(RawData_SetValue)

#define RawData_SetValueWithReset ASPECT_UNIQUE(RawData_SetValueWithReset)

#define RawData_GetValue ASPECT_UNIQUE(RawData_GetValue)

#define RawData_PreparePduSend ASPECT_UNIQUE(RawData_PreparePduSend)

#define RawData_ReworkPduRec ASPECT_UNIQUE(RawData_ReworkPduRec)

#define RawData_ReworkPduSend ASPECT_UNIQUE(RawData_ReworkPduSend)

#define CounterSignal_Init ASPECT_UNIQUE(CounterSignal_Init)

#define CounterSignal_VariableInitialize ASPECT_UNIQUE(CounterSignal_VariableInitialize)

#define CounterSignal_OnStart ASPECT_UNIQUE(CounterSignal_OnStart)

#define CounterSignal_MainFunction ASPECT_UNIQUE(CounterSignal_MainFunction)

#define CounterSignal_SetValue ASPECT_UNIQUE(CounterSignal_SetValue)

#define CounterSignal_SetValueWithReset ASPECT_UNIQUE(CounterSignal_SetValueWithReset)

#define CounterSignal_GetValue ASPECT_UNIQUE(CounterSignal_GetValue)

#define CounterSignal_Count ASPECT_UNIQUE(CounterSignal_Count)

#define CounterSignal_Revert ASPECT_UNIQUE(CounterSignal_Revert)

#define CounterSignal_Analyze ASPECT_UNIQUE(CounterSignal_Analyze)
