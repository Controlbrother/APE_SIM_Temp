...
extern Std_ReturnType DsBusCustomCode_onApplicationInit_usertimesync(DsBusCustomCodePduFeatureHandle PduFeatureHandle);
extern Std_ReturnType DsBusCustomCode_onApplicationStart_usertimesync(DsBusCustomCodePduFeatureHandle PduFeatureHandle);
extern Std_ReturnType DsBusCustomCode_onApplicationTerminate_usertimesync(DsBusCustomCodePduFeatureHandle PduFeatureHandle);
extern Std_ReturnType DsBusCustomCode_onPduFeatureExecution_usertimesync(DsBusCustomCodePduFeatureHandle PduFeatureHandle);
...
DsBusCustomCodePduFeatureHandle Feature_UserCode_TX_Feature_ADAS_AD1_119553_232436_FH; /**< Feature Handle */
DsBusCustomCodePduHandle Feature_UserCode_TX_Feature_ADAS_AD1_119553_232436_PH; /**< PDU Handle */
DsBusCustomCodeSignalHandle Feature_UserCode_TX_Feature_ADAS_AD1_119553_232436_S[1];
...
Std_ReturnType UserCode_PreparePduSend(Feature_PduIdType PduId, const PduInfoType * PduInfoPtr)
{
    ...
    switch (PduId)
    {
        case Feature_ADAS_AD1_209079_119553_232436_TX:
        {
            DsBusCustomCodePdu_setSduLength(Feature_UserCode_TX_Feature_ADAS_AD1_119553_232436_PH, PduInfoPtr->SduLength);
            DsBusCustomCodePdu_setSduDataPtr(Feature_UserCode_TX_Feature_ADAS_AD1_119553_232436_PH, PduInfoPtr->SduDataPtr);
            result = DsBusCustomCode_onPduFeatureExecution_usertimesync( Feature_UserCode_TX_Feature_ADAS_AD1_119553_232436_FH);
            break;
        }
    }
    return result;
...
{
    {
        ...
        DsBusCustomCodeUserCodePduFeature_generateHandle(&Feature_UserCode_TX_Feature_ADAS_AD1_119553_232436_FH);
        DsBusCustomCode_setName(Feature_UserCode_TX_Feature_ADAS_AD1_119553_232436_FH, "usertimesync");
        DsBusCustomCodePdu_generateHandle(&Feature_UserCode_TX_Feature_ADAS_AD1_119553_232436_PH);
        DsBusCustomCodePduFeature_setPdu(Feature_UserCode_TX_Feature_ADAS_AD1_119553_232436_FH, Feature_UserCode_TX_Feature_ADAS_AD1_119553_232436_PH);
        DsBusCustomCodeSignal_generateHandle(&Feature_UserCode_TX_Feature_ADAS_AD1_119553_232436_S[0]);
        DsBusCustomCodeUserCodePduFeature_setNumberOfUserSignals(Feature_UserCode_TX_Feature_ADAS_AD1_119553_232436_FH, 1);
        DsBusCustomCodeUserCodePduFeature_setUserSignals(Feature_UserCode_TX_Feature_ADAS_AD1_119553_232436_FH, Feature_UserCode_TX_Feature_ADAS_AD1_119553_232436_S);
        /* initialization of handle set for ADAS_AD1 */
        DsBusCustomCode_setName(Feature_UserCode_TX_Feature_ADAS_AD1_119553_232436_PH, "ADAS_AD1" );
        DsBusCustomCodePdu_setIsTx(Feature_UserCode_TX_Feature_ADAS_AD1_119553_232436_PH, TRUE);
        /* set signal Sync_CRC properties */
        DsBusCustomCode_setName(Feature_UserCode_TX_Feature_ADAS_AD1_119553_232436_S[0], "Sync_CRC");
        DsBusCustomCodeSignal_setStartBitPosition(Feature_UserCode_TX_Feature_ADAS_AD1_119553_232436_S[0], 8);
        DsBusCustomCodeSignal_setLength(Feature_UserCode_TX_Feature_ADAS_AD1_119553_232436_S[0], 8);
        DsBusCustomCodeSignal_setEndianness(Feature_UserCode_TX_Feature_ADAS_AD1_119553_232436_S[0], BigEndian);
        /* call user code init function */
        DsBusCustomCode_onApplicationInit_usertimesync( Feature_UserCode_TX_Feature_ADAS_AD1_119553_232436_FH);
    }
