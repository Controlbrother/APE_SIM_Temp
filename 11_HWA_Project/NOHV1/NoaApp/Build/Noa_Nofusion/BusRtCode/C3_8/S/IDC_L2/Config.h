...
*
*  @brief Config File for F:/05_dspace_Work_Files/11_HWA_Project/NOHV1/NoaApp/Build/Noa_Nofusion/BusRtCode/C3_8/S/IDC_L2/Ecu.mk
*
*  @author
*
*  @description
...
#define RxStatusAccess_Init ASPECT_UNIQUE(RxStatusAccess_Init)

#define RxStatusAccess_GetValue ASPECT_UNIQUE(RxStatusAccess_GetValue)

#define RxStatusAccess_SetValue ASPECT_UNIQUE(RxStatusAccess_SetValue)

#define RxStatusAccess_OnStart ASPECT_UNIQUE(RxStatusAccess_OnStart)

#define RxStatusAccess_MainFunction ASPECT_UNIQUE(RxStatusAccess_MainFunction)

#define RxStatusAccess_VariableInitialize ASPECT_UNIQUE(RxStatusAccess_VariableInitialize)

#define RxStatusAccess_SetValueWithReset ASPECT_UNIQUE(RxStatusAccess_SetValueWithReset)

#define RxStatusAccess_ReworkPduRec ASPECT_UNIQUE(RxStatusAccess_ReworkPduRec)

#define RxStatusAccess_IpduM_FrameHandler ASPECT_UNIQUE(RxStatusAccess_IpduM_FrameHandler)

#define RxStatusAccess_SecOC_FrameHandler ASPECT_UNIQUE(RxStatusAccess_SecOC_FrameHandler)
