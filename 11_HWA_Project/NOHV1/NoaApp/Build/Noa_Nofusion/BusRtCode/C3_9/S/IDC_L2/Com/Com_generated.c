...
static uint8 Com_Frame_TX_Com_ADAS_AD1_209087_119558_232436 [16];
static PduInfoType Com_Pdu_TX_Com_ADAS_AD1_209087_119558_232436;
uint8 Com_TX_Inst_1136_Sync_CRC_197911_119558_232436_sgn_val;
uint8 Com_TX_Inst_1136_Sync_OVS_197912_119558_232436_sgn_val;
uint8 Com_TX_Inst_1136_Sync_Resd_197913_119558_232436_sgn_val;
uint8 Com_TX_Inst_1136_Sync_Counter_197914_119558_232436_sgn_val;
uint8 Com_TX_Inst_1136_Sync_SGW_197915_119558_232436_sgn_val;
uint32 Com_TX_Inst_1136_Sync_SyncTime_197916_119558_232436_sgn_val;
uint8 Com_TX_Inst_1136_Sync_TimeDomain_197917_119558_232436_sgn_val;
uint8 Com_TX_Inst_1136_Sync_Type_197918_119558_232436_sgn_val;
...
static BinaryHeap timingQueue_13 = BINARY_HEAP_CREATE(Com_CyclicHeapEntry, CyclicCompare);


/*------------------------------------------------------------------------------------------------*\
  PROTOTYPES
\*------------------------------------------------------------------------------------------------*/
static void ComControllerStateChanged13(uint32 index, uint8 newState, uint8 oldState);
...
static void ComControllerStateChanged13(uint32 index, uint8 newState, uint8 oldState)
{
    ...
    if (newState > 0)
    {
        ...
        BinaryHeapClear(&timingQueue_13);
        Com_Schedule_CyclicTimingPdus(&timingQueue_13,Com_ADAS_AD1_209087_119558_232436, 0LL, 500000L);
    }
}
...
void Com_Init(const Com_ConfigType* config)
{
    ...
    Com_Pdu_TX_Com_ADAS_AD1_209087_119558_232436.SduDataPtr = Com_Frame_TX_Com_ADAS_AD1_209087_119558_232436;
    Com_Pdu_TX_Com_ADAS_AD1_209087_119558_232436.SduLength  = 16;
    Com_Pdu_TX_Com_ADAS_AD1_209087_119558_232436.MetaDataPtr = NULL_PTR;

    /* Initialization of the RX I-PDU data structs */


    /* Register callback for ComControllerEnable state */
    StateManager_RegisterCallback(13, ComControllerStateChanged13);
...
void Com_VariableInitialize(void)
{
    ...
    memset(Com_Frame_TX_Com_ADAS_AD1_209087_119558_232436, 0x00, sizeof(Com_Frame_TX_Com_ADAS_AD1_209087_119558_232436));
    /* Initialization of the TX signals and triggers */
    Com_TX_Inst_1136_Sync_CRC_197911_119558_232436_sgn_val = (uint8) 0;
    Rte_SetCodedValue(Com_X_Inst_1136_Sync_CRC_197911_119558_232436, 1);
    /* Signal: Sync_CRC */
            {
                int copyCounter;
                uint8* destData = (uint8*)Com_Pdu_TX_Com_ADAS_AD1_209087_119558_232436.SduDataPtr;
                uint8 shiftData = ((uint8)READ8(&Com_TX_Inst_1136_Sync_CRC_197911_119558_232436_sgn_val) & (uint8)0xFF) << 0;
    ...
    Com_TX_Inst_1136_Sync_OVS_197912_119558_232436_sgn_val = (uint8) 0;
    Rte_SetCodedValue(Com_X_Inst_1136_Sync_OVS_197912_119558_232436, 1);
    /* Signal: Sync_OVS */
            {
                int copyCounter;
                uint8* destData = (uint8*)Com_Pdu_TX_Com_ADAS_AD1_209087_119558_232436.SduDataPtr;
                uint8 shiftData = ((uint8)READ8(&Com_TX_Inst_1136_Sync_OVS_197912_119558_232436_sgn_val) & (uint8)0x3) << 0;
    ...
    Com_TX_Inst_1136_Sync_Resd_197913_119558_232436_sgn_val = (uint8) 0;
    Rte_SetCodedValue(Com_X_Inst_1136_Sync_Resd_197913_119558_232436, 1);
    /* Signal: Sync_Resd */
            {
                int copyCounter;
                uint8* destData = (uint8*)Com_Pdu_TX_Com_ADAS_AD1_209087_119558_232436.SduDataPtr;
                uint8 shiftData = ((uint8)READ8(&Com_TX_Inst_1136_Sync_Resd_197913_119558_232436_sgn_val) & (uint8)0x1F) << 3;
    ...
    Com_TX_Inst_1136_Sync_Counter_197914_119558_232436_sgn_val = (uint8) 0;
    Rte_SetCodedValue(Com_X_Inst_1136_Sync_Counter_197914_119558_232436, 1);
    /* Signal: Sync_Counter */
            {
                int copyCounter;
                uint8* destData = (uint8*)Com_Pdu_TX_Com_ADAS_AD1_209087_119558_232436.SduDataPtr;
                uint8 shiftData = ((uint8)READ8(&Com_TX_Inst_1136_Sync_Counter_197914_119558_232436_sgn_val) & (uint8)0xF) << 0;
    ...
    Com_TX_Inst_1136_Sync_SGW_197915_119558_232436_sgn_val = (uint8) 0;
    Rte_SetCodedValue(Com_X_Inst_1136_Sync_SGW_197915_119558_232436, 1);
    /* Signal: Sync_SGW */
            {
                int copyCounter;
                uint8* destData = (uint8*)Com_Pdu_TX_Com_ADAS_AD1_209087_119558_232436.SduDataPtr;
                uint8 shiftData = ((uint8)READ8(&Com_TX_Inst_1136_Sync_SGW_197915_119558_232436_sgn_val) & (uint8)0x1) << 2;
    ...
    Com_TX_Inst_1136_Sync_SyncTime_197916_119558_232436_sgn_val = (uint32) 0;
    Rte_SetCodedValue(Com_X_Inst_1136_Sync_SyncTime_197916_119558_232436, 1);
    /* Signal: Sync_SyncTime */
            {
                int copyCounter;
                uint8* destData = (uint8*)Com_Pdu_TX_Com_ADAS_AD1_209087_119558_232436.SduDataPtr;
                uint32 shiftData = ((uint32)READ32(&Com_TX_Inst_1136_Sync_SyncTime_197916_119558_232436_sgn_val) & (uint32)0xFFFFFFFF) << 0;
    ...
    Com_TX_Inst_1136_Sync_TimeDomain_197917_119558_232436_sgn_val = (uint8) 0;
    Rte_SetCodedValue(Com_X_Inst_1136_Sync_TimeDomain_197917_119558_232436, 1);
    /* Signal: Sync_TimeDomain */
            {
                int copyCounter;
                uint8* destData = (uint8*)Com_Pdu_TX_Com_ADAS_AD1_209087_119558_232436.SduDataPtr;
                uint8 shiftData = ((uint8)READ8(&Com_TX_Inst_1136_Sync_TimeDomain_197917_119558_232436_sgn_val) & (uint8)0xF) << 4;
    ...
    Com_TX_Inst_1136_Sync_Type_197918_119558_232436_sgn_val = (uint8) 0;
    Rte_SetCodedValue(Com_X_Inst_1136_Sync_Type_197918_119558_232436, 1);
    /* Signal: Sync_Type */
            {
                int copyCounter;
                uint8* destData = (uint8*)Com_Pdu_TX_Com_ADAS_AD1_209087_119558_232436.SduDataPtr;
                uint8 shiftData = ((uint8)READ8(&Com_TX_Inst_1136_Sync_Type_197918_119558_232436_sgn_val) & (uint8)0xFF) << 0;
                uint8 mask = (uint8)0xFF << 0;
                uint8 resultMask = INT8_TO_BE(~mask);
                uint8 resultData = INT8_TO_BE(shiftData);
...
void Com_OnStart(void)
{
    ...
    ComControllerStateChanged13(13, 1, 0);
...
#endif
{
    ...
    switch (ComTxPduId)
    {
        case Com_ADAS_AD1_209087_119558_232436:
        { /* Pdu: ADAS_AD1 */

            /* call to PDU feature before transmission */
            if (Feature_ComPreparePduSend(Feature_ADAS_AD1_209087_119558_232436_TX, &Com_Pdu_TX_Com_ADAS_AD1_209087_119558_232436) != E_OK)
            {
                result = E_DISABLED;
            }
            ...
            {
                result = PduR_ComTransmit(PDUR_TX_ADAS_AD1_119558_232436, &Com_Pdu_TX_Com_ADAS_AD1_209087_119558_232436);
            }
            return result;
        }
    }
...
Std_ReturnType Com_TriggerTransmit(PduIdType ComTxPduId, PduInfoType * PduInfoPtr)
{
    ...
    switch (ComTxPduId)
    {
        ...
        { /* Pdu: ADAS_AD1 */
            ...
            /* call to PDU feature before transmission */
            Feature_ComPreparePduSend(Feature_ADAS_AD1_209087_119558_232436_TX, &Com_Pdu_TX_Com_ADAS_AD1_209087_119558_232436);
            if (PduInfoPtr != NULL_PTR)
            {
                PduInfoPtr->SduLength = Com_Pdu_TX_Com_ADAS_AD1_209087_119558_232436.SduLength;
                if(PduInfoPtr->SduDataPtr != Com_Pdu_TX_Com_ADAS_AD1_209087_119558_232436.SduDataPtr)
                {
                    memcpy(PduInfoPtr->SduDataPtr, Com_Pdu_TX_Com_ADAS_AD1_209087_119558_232436.SduDataPtr, PduInfoPtr->SduLength);
                }
            }
...
uint8 Com_SendSignal(Com_SignalIdType SignalId, const void * SignalDataPtr)
{
    ...
    switch (SignalId)
    {
        case Com_X_Inst_1136_Sync_CRC_197911_119558_232436:
        {
            Com_TX_Inst_1136_Sync_CRC_197911_119558_232436_sgn_val = *((uint8*) SignalDataPtr);
            return E_OK;
        }
        case Com_X_Inst_1136_Sync_OVS_197912_119558_232436:
        {
            Com_TX_Inst_1136_Sync_OVS_197912_119558_232436_sgn_val = *((uint8*) SignalDataPtr);
            return E_OK;
        }
        case Com_X_Inst_1136_Sync_Resd_197913_119558_232436:
        {
            Com_TX_Inst_1136_Sync_Resd_197913_119558_232436_sgn_val = *((uint8*) SignalDataPtr);
            return E_OK;
        }
        case Com_X_Inst_1136_Sync_Counter_197914_119558_232436:
        {
            Com_TX_Inst_1136_Sync_Counter_197914_119558_232436_sgn_val = *((uint8*) SignalDataPtr);
            return E_OK;
        }
        case Com_X_Inst_1136_Sync_SGW_197915_119558_232436:
        {
            Com_TX_Inst_1136_Sync_SGW_197915_119558_232436_sgn_val = *((uint8*) SignalDataPtr);
            return E_OK;
        }
        case Com_X_Inst_1136_Sync_SyncTime_197916_119558_232436:
        {
            Com_TX_Inst_1136_Sync_SyncTime_197916_119558_232436_sgn_val = *((uint32*) SignalDataPtr);
            return E_OK;
        }
        case Com_X_Inst_1136_Sync_TimeDomain_197917_119558_232436:
        {
            Com_TX_Inst_1136_Sync_TimeDomain_197917_119558_232436_sgn_val = *((uint8*) SignalDataPtr);
            return E_OK;
        }
        case Com_X_Inst_1136_Sync_Type_197918_119558_232436:
        {
            Com_TX_Inst_1136_Sync_Type_197918_119558_232436_sgn_val = *((uint8*) SignalDataPtr);
            return E_OK;
        }
    }
...
#endif
{
    ...
    */
    Com_CheckHeapAndSend(&timingQueue_13, period, 2);
}
...
{
    if (BM_CR_PCANFD_9_IDC_L2__CreditCountersAvailable() > 0) 
    {
        /* Trigger Tx Function */
