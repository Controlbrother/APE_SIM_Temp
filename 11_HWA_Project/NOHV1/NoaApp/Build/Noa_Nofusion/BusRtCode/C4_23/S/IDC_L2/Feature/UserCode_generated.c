...
DsBusCustomCodePduFeatureHandle Feature_UserCode_TX_Feature_ACC_FD1_119633_232437_FH; /**< Feature Handle */
DsBusCustomCodePduHandle Feature_UserCode_TX_Feature_ACC_FD1_119633_232437_PH; /**< PDU Handle */
DsBusCustomCodeSignalHandle Feature_UserCode_TX_Feature_ACC_FD1_119633_232437_S[1];
...
Std_ReturnType UserCode_PreparePduSend(Feature_PduIdType PduId, const PduInfoType * PduInfoPtr)
{
    ...
    switch (PduId)
    {
        case Feature_ACC_FD1_209462_119633_232437_TX:
        {
            DsBusCustomCodePdu_setSduLength(Feature_UserCode_TX_Feature_ACC_FD1_119633_232437_PH, PduInfoPtr->SduLength);
            DsBusCustomCodePdu_setSduDataPtr(Feature_UserCode_TX_Feature_ACC_FD1_119633_232437_PH, PduInfoPtr->SduDataPtr);
            result = DsBusCustomCode_onPduFeatureExecution_checksum_acc1( Feature_UserCode_TX_Feature_ACC_FD1_119633_232437_FH);
            break;
        }
    }
    return result;
...
{
    {
        ...
        DsBusCustomCodeUserCodePduFeature_generateHandle(&Feature_UserCode_TX_Feature_ACC_FD1_119633_232437_FH);
        DsBusCustomCode_setName(Feature_UserCode_TX_Feature_ACC_FD1_119633_232437_FH, "checksum_acc1");
        DsBusCustomCodePdu_generateHandle(&Feature_UserCode_TX_Feature_ACC_FD1_119633_232437_PH);
        DsBusCustomCodePduFeature_setPdu(Feature_UserCode_TX_Feature_ACC_FD1_119633_232437_FH, Feature_UserCode_TX_Feature_ACC_FD1_119633_232437_PH);
        DsBusCustomCodeSignal_generateHandle(&Feature_UserCode_TX_Feature_ACC_FD1_119633_232437_S[0]);
        DsBusCustomCodeUserCodePduFeature_setNumberOfUserSignals(Feature_UserCode_TX_Feature_ACC_FD1_119633_232437_FH, 1);
        DsBusCustomCodeUserCodePduFeature_setUserSignals(Feature_UserCode_TX_Feature_ACC_FD1_119633_232437_FH, Feature_UserCode_TX_Feature_ACC_FD1_119633_232437_S);
        /* initialization of handle set for ACC_FD1 */
        DsBusCustomCode_setName(Feature_UserCode_TX_Feature_ACC_FD1_119633_232437_PH, "ACC_FD1" );
        DsBusCustomCodePdu_setIsTx(Feature_UserCode_TX_Feature_ACC_FD1_119633_232437_PH, TRUE);
        /* set signal Checksum_ACC11 properties */
        DsBusCustomCode_setName(Feature_UserCode_TX_Feature_ACC_FD1_119633_232437_S[0], "Checksum_ACC11");
        DsBusCustomCodeSignal_setStartBitPosition(Feature_UserCode_TX_Feature_ACC_FD1_119633_232437_S[0], 0);
        DsBusCustomCodeSignal_setLength(Feature_UserCode_TX_Feature_ACC_FD1_119633_232437_S[0], 8);
        DsBusCustomCodeSignal_setEndianness(Feature_UserCode_TX_Feature_ACC_FD1_119633_232437_S[0], BigEndian);
        /* call user code init function */
        DsBusCustomCode_onApplicationInit_checksum_acc1( Feature_UserCode_TX_Feature_ACC_FD1_119633_232437_FH);
    }
