...
static CanIfTxPduConfig TxPduConfig[] = {
    /* RSDS-ADAS-Private__V0.4 */
    {
        CanIf_RSDSminusADASminusPrivate__V0_4_ADAS_AD1_FrameTrig, /* CanIf Pdu Id */
...
static VAR(CanIfRxPduConfig, AUTOMATIC) RxPduConfig[] =
{
    /* RSDS-ADAS-Private__V0.4 */
    {
        CanIf_RSDSminusADASminusPrivate__V0_4_RSDS_L_AD1_FrameTrig, /* CanIf Pdu Id */
        1088, /* 0x00000440 CAN Id */
        64, /* DLC */
        ...
        PDUR_RX_RSDS_L_AD1_119558_232435_CanIf_Com, /* PduIdRef */
        0, /* RxPduCanIdRange */
    ...
    {
        CanIf_RSDSminusADASminusPrivate__V0_4_RSDS_L_AD2_FrameTrig, /* CanIf Pdu Id */
        1089, /* 0x00000441 CAN Id */
        64, /* DLC */
        FALSE, /* CanIfReadRxPduData */
        FALSE, /* CanIfReadRxPduNotifyStatus */
        STANDARD_FD_CAN_BRS_ON, /* CAN Id Type */
        ...
        PduR_CanIfRxIndication, /* User RX indication */
        0, /* CanIfCanRxPduHrhRef */
        PDUR_RX_RSDS_L_AD2_119558_232435_CanIf_Com, /* PduIdRef */
        0, /* RxPduCanIdRange */
        0, /* CanIfRxPduDataBufferInd */
        NULL_PTR, /* RX Interrupt function pointer */
        0, /*Rx Interrupt State Manager index */
    ...
    {
        CanIf_RSDSminusADASminusPrivate__V0_4_RSDS_L_AD3_FrameTrig, /* CanIf Pdu Id */
        1090, /* 0x00000442 CAN Id */
        64, /* DLC */
        FALSE, /* CanIfReadRxPduData */
        FALSE, /* CanIfReadRxPduNotifyStatus */
        STANDARD_FD_CAN_BRS_ON, /* CAN Id Type */
        ...
        PduR_CanIfRxIndication, /* User RX indication */
        0, /* CanIfCanRxPduHrhRef */
        PDUR_RX_RSDS_L_AD3_119558_232435_CanIf_Com, /* PduIdRef */
        0, /* RxPduCanIdRange */
        0, /* CanIfRxPduDataBufferInd */
        NULL_PTR, /* RX Interrupt function pointer */
        0, /*Rx Interrupt State Manager index */
    ...
    {
        CanIf_RSDSminusADASminusPrivate__V0_4_RSDS_R_AD1_FrameTrig, /* CanIf Pdu Id */
        1091, /* 0x00000443 CAN Id */
        64, /* DLC */
        FALSE, /* CanIfReadRxPduData */
        FALSE, /* CanIfReadRxPduNotifyStatus */
        STANDARD_FD_CAN_BRS_ON, /* CAN Id Type */
        ...
        PduR_CanIfRxIndication, /* User RX indication */
        0, /* CanIfCanRxPduHrhRef */
        PDUR_RX_RSDS_R_AD1_119558_232435_CanIf_Com, /* PduIdRef */
        0, /* RxPduCanIdRange */
        0, /* CanIfRxPduDataBufferInd */
        NULL_PTR, /* RX Interrupt function pointer */
        0, /*Rx Interrupt State Manager index */
    ...
    {
        CanIf_RSDSminusADASminusPrivate__V0_4_RSDS_R_AD2_FrameTrig, /* CanIf Pdu Id */
        1092, /* 0x00000444 CAN Id */
        64, /* DLC */
        FALSE, /* CanIfReadRxPduData */
        FALSE, /* CanIfReadRxPduNotifyStatus */
        STANDARD_FD_CAN_BRS_ON, /* CAN Id Type */
        ...
        PduR_CanIfRxIndication, /* User RX indication */
        0, /* CanIfCanRxPduHrhRef */
        PDUR_RX_RSDS_R_AD2_119558_232435_CanIf_Com, /* PduIdRef */
        0, /* RxPduCanIdRange */
        0, /* CanIfRxPduDataBufferInd */
        NULL_PTR, /* RX Interrupt function pointer */
        0, /*Rx Interrupt State Manager index */
    ...
    {
        CanIf_RSDSminusADASminusPrivate__V0_4_RSDS_R_AD3_FrameTrig, /* CanIf Pdu Id */
        1093, /* 0x00000445 CAN Id */
        64, /* DLC */
        FALSE, /* CanIfReadRxPduData */
        FALSE, /* CanIfReadRxPduNotifyStatus */
        STANDARD_FD_CAN_BRS_ON, /* CAN Id Type */
        ...
        PduR_CanIfRxIndication, /* User RX indication */
        0, /* CanIfCanRxPduHrhRef */
        PDUR_RX_RSDS_R_AD3_119558_232435_CanIf_Com, /* PduIdRef */
        0, /* RxPduCanIdRange */
        0, /* CanIfRxPduDataBufferInd */
        NULL_PTR, /* RX Interrupt function pointer */
        0, /*Rx Interrupt State Manager index */
...
{
     {
            ...
            10,     /* Index in StateManager to handle ComControllerEnable state */
            2,    /* Index in StateManager for used credit counter */
...
void CanIf_VariableInitialize(void)
{
    ...
    StateManager_SetState_Mutex(10,controllerState);
