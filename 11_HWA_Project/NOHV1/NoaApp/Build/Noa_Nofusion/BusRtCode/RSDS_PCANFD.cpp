...
#include "C2_8/BusManager_RSDS_PCANFD_8.h"
#include "C2_9/BusManager_RSDS_PCANFD_9.h"
...
{
    BM_RSDS_PCANFD_8_IDC_L2_Com_MainFunction,
    BM_RSDS_PCANFD_9_IDC_L2_Com_MainFunction,
};
static uint32 preferredCom_MainFunctionIndex;
static void (*rrFeature_MainFunctions[]) (sint64 param) =
{
    BM_RSDS_PCANFD_8_IDC_L2_Feature_MainFunction,
    BM_RSDS_PCANFD_9_IDC_L2_Feature_MainFunction,
};
 ...
 ***     void
\**************************************************************************************************/
void RSDS_PCANFD_VariableInitialize(void)
{
...
void RSDS_PCANFD_Com_MainFunction_232336(void)
{
	uint32 i;
    DoPossibleCreditCounterInitialization();
    BM_RSDS_PCANFD_8_IDC_L2_CanIf_UpdateBoards();
    BM_RSDS_PCANFD_9_IDC_L2_CanIf_UpdateBoards();
