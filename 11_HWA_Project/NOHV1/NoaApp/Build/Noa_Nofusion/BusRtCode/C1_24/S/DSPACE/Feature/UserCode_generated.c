...
/* definition of handle set for SecOC_SyncMsg */
DsBusCustomCodePduFeatureHandle Feature_UserCode_RX_Feature_SecOC_SyncMsg_119641_232434_FH; /**< Feature Handle */
DsBusCustomCodePduHandle Feature_UserCode_RX_Feature_SecOC_SyncMsg_119641_232434_PH; /**< PDU Handle */
DsBusCustomCodeSignalHandle Feature_UserCode_RX_Feature_SecOC_SyncMsg_119641_232434_S[2];
...
Std_ReturnType UserCode_PostReceive(Feature_PduIdType PduId, const PduInfoType * PduInfoPtr)
{
    ...
    switch (PduId)
    {
        case Feature_SecOC_SyncMsg_209577_119641_232434_RX:
        {
            DsBusCustomCodePdu_setSduLength(Feature_UserCode_RX_Feature_SecOC_SyncMsg_119641_232434_PH, PduInfoPtr->SduLength);
            DsBusCustomCodePdu_setSduDataPtr(Feature_UserCode_RX_Feature_SecOC_SyncMsg_119641_232434_PH, PduInfoPtr->SduDataPtr);
            return DsBusCustomCode_onPduFeatureExecution_checksum_acc1( Feature_UserCode_RX_Feature_SecOC_SyncMsg_119641_232434_FH);
            break;
        }
    }
    return E_OK;
...
{
    {
        /* Init Pdu UserCode-Feature SecOC_SyncMsg */
        DsBusCustomCodeUserCodePduFeature_generateHandle(&Feature_UserCode_RX_Feature_SecOC_SyncMsg_119641_232434_FH);
        DsBusCustomCode_setName(Feature_UserCode_RX_Feature_SecOC_SyncMsg_119641_232434_FH, "checksum_acc1");
        DsBusCustomCodePdu_generateHandle(&Feature_UserCode_RX_Feature_SecOC_SyncMsg_119641_232434_PH);
        DsBusCustomCodePduFeature_setPdu(Feature_UserCode_RX_Feature_SecOC_SyncMsg_119641_232434_FH, Feature_UserCode_RX_Feature_SecOC_SyncMsg_119641_232434_PH);
        DsBusCustomCodeSignal_generateHandle(&Feature_UserCode_RX_Feature_SecOC_SyncMsg_119641_232434_S[0]);
        DsBusCustomCodeSignal_generateHandle(&Feature_UserCode_RX_Feature_SecOC_SyncMsg_119641_232434_S[1]);
        DsBusCustomCodeUserCodePduFeature_setNumberOfUserSignals(Feature_UserCode_RX_Feature_SecOC_SyncMsg_119641_232434_FH, 2);
        DsBusCustomCodeUserCodePduFeature_setUserSignals(Feature_UserCode_RX_Feature_SecOC_SyncMsg_119641_232434_FH, Feature_UserCode_RX_Feature_SecOC_SyncMsg_119641_232434_S);
        /* initialization of handle set for SecOC_SyncMsg */
        DsBusCustomCode_setName(Feature_UserCode_RX_Feature_SecOC_SyncMsg_119641_232434_PH, "SecOC_SyncMsg" );
        DsBusCustomCodePdu_setIsTx(Feature_UserCode_RX_Feature_SecOC_SyncMsg_119641_232434_PH, FALSE);
        /* set signal resetCnt properties */
        DsBusCustomCode_setName(Feature_UserCode_RX_Feature_SecOC_SyncMsg_119641_232434_S[0], "resetCnt");
        DsBusCustomCodeSignal_setStartBitPosition(Feature_UserCode_RX_Feature_SecOC_SyncMsg_119641_232434_S[0], 24);
        DsBusCustomCodeSignal_setLength(Feature_UserCode_RX_Feature_SecOC_SyncMsg_119641_232434_S[0], 16);
        DsBusCustomCodeSignal_setEndianness(Feature_UserCode_RX_Feature_SecOC_SyncMsg_119641_232434_S[0], BigEndian);
        /* set signal tripCnt properties */
        DsBusCustomCode_setName(Feature_UserCode_RX_Feature_SecOC_SyncMsg_119641_232434_S[1], "tripCnt");
        DsBusCustomCodeSignal_setStartBitPosition(Feature_UserCode_RX_Feature_SecOC_SyncMsg_119641_232434_S[1], 0);
        DsBusCustomCodeSignal_setLength(Feature_UserCode_RX_Feature_SecOC_SyncMsg_119641_232434_S[1], 24);
        DsBusCustomCodeSignal_setEndianness(Feature_UserCode_RX_Feature_SecOC_SyncMsg_119641_232434_S[1], BigEndian);
        /* call user code init function */
        DsBusCustomCode_onApplicationInit_checksum_acc1( Feature_UserCode_RX_Feature_SecOC_SyncMsg_119641_232434_FH);
    }
...
void UserCode_VariableInitialize(void)
{
    ...
    {
        /* Init Pdu UserCode-Feature SecOC_SyncMsg result */
        DsBusCustomCodeUserCodePduFeature_setResult(Feature_UserCode_RX_Feature_SecOC_SyncMsg_119641_232434_FH, 0);
    }
}
