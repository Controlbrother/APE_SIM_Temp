...
static VAR(CanIfRxPduConfig, AUTOMATIC) RxPduConfig[] =
{
    /* V71_SecOC_SyncMsg */
    {
        CanIf_V71_SecOC_SyncMsg_SecOC_SyncMsg_FrameTrig, /* CanIf Pdu Id */
        1121, /* 0x00000461 CAN Id */
        16, /* DLC */
        ...
        PDUR_RX_SecOC_SyncMsg_119641_232434_CanIf_Com, /* PduIdRef */
        0, /* RxPduCanIdRange */
...
{
    {
            1, /* Number of CAN RX PDU IDs */
            0, /* Number of CAN TX PDU IDs */
...
{
    {
            ...
            NULL_PTR, /* CanIfDispatchTransmit */
...
{
     {
            ...
            7,     /* Index in StateManager to handle ComControllerEnable state */
...
void CanIf_VariableInitialize(void)
{
    ...
    StateManager_SetState_Mutex(7,controllerState);
