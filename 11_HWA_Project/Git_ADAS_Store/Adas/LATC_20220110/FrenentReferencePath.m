classdef FrenentReferencePath < handle     %FrenentReferencePath类的名称
    ...
    %   respect to arclength, S.   %S是关于时间t的函数，L是关于S的函数
    %
    ...
    properties(Access = public)   %这是一个类 其中包括PathPoints、DiscretizationDistance、Waypoints三个对象？？？
    ...
    methods(Access = public)
        ...
        function generationCartesianStates(obj,waypoints,GtNumTrajpoints)
            ...
            obj.DiscretizationDistance = s(1,3)-s(1,2);    %这个是什么意思
